...
@Component({
  selector: 'app-edit-return-bill-form',
  templateUrl: './edit-return-bill-form.component.html',
  styleUrls: ['./edit-return-bill-form.component.css']
})
export class EditReturnBillFormComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditReturnBillFormComponent>,
  ...
  ngOnInit() {
   ...
   this.returnBillService.getOneById(this.id).subscribe((outereRsponse:any)=>{
      console.log("outereRsponse",outereRsponse);
      this.BillReturn_Date = outereRsponse.BillReturn_Date;
      this.BillReturn_Note = outereRsponse.BillReturn_Note;
      this.suppliers.push(outereRsponse.Bill_Supplier.Supplier_Name+',Code('+outereRsponse.Bill_Supplier.Supplier_Code+')');
      this.supplierCtrl.setValue(outereRsponse.Bill_Supplier)
      this.supplierInput.nativeElement.value = "";
      this.BillReturn_Products = outereRsponse.BillReturn_Products
  ...
  onSubmit() {
    ...
    console.log("this.BillReturn_Note",this.BillReturn_Note)
        ...
        this.returnBillService.updateSupplierReturnBill(
          DataToSend, this.id
        ).subscribe((status) => {
          if(status==true)
