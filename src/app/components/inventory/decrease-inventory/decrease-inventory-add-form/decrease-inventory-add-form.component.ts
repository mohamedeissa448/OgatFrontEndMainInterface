...
@Component({
  selector: 'app-decrease-inventory-add-form',
  templateUrl: './decrease-inventory-add-form.component.html',
  styleUrls: ['./decrease-inventory-add-form.component.css']
})
export class DecreaseInventoryAddFormComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DecreaseInventoryAddFormComponent>,
  ...
  onSubmit() {
    ...
    console.log("this.DecreaseInventory_Note",this.DecreaseInventory_Note)
        ...
        this.decreaseInventoryService.addDecreaseInventory(
          DataToSend
        ).subscribe((status) => {
          if(status==true)
