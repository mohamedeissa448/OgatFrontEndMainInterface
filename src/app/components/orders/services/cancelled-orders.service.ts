...
export class CancelledOrdersService {
  ...
  getAllCancelledOrders() {
    return this.http.get(`${systemSettings.serverURL}/orders/getAllCancelledOrders`)
  }
  ...
  changeOrderFromCancelledToCreated(dataToSend){
    return this.http
      .post(`${systemSettings.serverURL}/orders/changeOrderFromCancelledToCreated`, dataToSend)
      .pipe(
        map((response: any) => {
