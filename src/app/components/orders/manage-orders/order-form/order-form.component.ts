...
export class OrderFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.manageOrderService.getProducts().subscribe((products:any)=>{
    ...
    this.manageOrderService.getColorVariants().subscribe((response)=>{
      this.colorVariants=response;
    }) ;
    this.manageOrderService.getSizes().subscribe((response)=>{
      this.sizeVariants=response;
    });
    this.manageOrderService.getProvinces().subscribe((response)=>{
      this.provinces=response;
    });
    this.manageOrderService.getCustomers().subscribe((response :any)=>{
    ...
    this.manageOrderService.getAllUsers().subscribe((response)=>{
      this.users=response;
    });

    //initialize form inputs incase of editing
    if(this.title == "Assign Task"){
      this.manageOrderService.getAffiliateSellerOrderById(this.id).subscribe((outereRsponse:any)=>{
        ...
        this.customerInput.nativeElement.value = "";
          ...
          this.manageOrderService.getOneProductFromStore({
  ...
  onSubmit() {
    ...
    this.manageOrderService.assignOrderTo(dataToSend).subscribe((status)=>{
      if(status==true)
